...
# static fields
.field private static final ACTION_EXTERNAL_STEREO_MIC_PLUG:Ljava/lang/String; = "com.sonymobile.media.intent.action.ACTION_EXTERNAL_STEREO_MIC_PLUG"
...
.field private static final MSG_USER_REMOVED:I = 0x23

.field private static final MSG_USER_SWITCHED:I = 0x22
...
.field private final mSoundRegulation:Z
...
.field private final mWfdSinkVolumePanelLauncher:Lcom/sonymobile/tvout/wifidisplay/volumecontrol/WfdSinkVolumePanelLauncher;
...
.method static constructor <clinit>()V
    ...
    const-string v2, "STREAM_INCALL_MUSIC"
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget-object v11, Landroid/media/AudioService;->MAX_STREAM_VOLUME:[I
    ...
    iget-object v11, p0, Landroid/media/AudioService;->mVolumeController:Landroid/media/AudioService$VolumeController;

    invoke-direct {v0, v1, v3, v11, p0}, Landroid/media/MediaFocusControl;-><init>(Landroid/os/Looper;Landroid/content/Context;Landroid/media/AudioService$VolumeController;Landroid/media/AudioService;)V
    ...
    .line 621
    const-string/jumbo v0, "ro.audio.sound_regulation"

    invoke-static {v0, v13}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    iput-boolean v0, p0, Landroid/media/AudioService;->mSoundRegulation:Z

    .line 622
    invoke-direct {p0}, Landroid/media/AudioService;->checkSoundRegulation()V
    ...
    .line 694
    new-instance v0, Lcom/sonymobile/tvout/wifidisplay/volumecontrol/WfdSinkVolumePanelLauncher;

    invoke-direct {v0, p1}, Lcom/sonymobile/tvout/wifidisplay/volumecontrol/WfdSinkVolumePanelLauncher;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/media/AudioService;->mWfdSinkVolumePanelLauncher:Lcom/sonymobile/tvout/wifidisplay/volumecontrol/WfdSinkVolumePanelLauncher;
...
.method static synthetic access$10100(Landroid/media/AudioService;)Ljava/util/HashMap;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$7800(Landroid/media/AudioService;IILjava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Landroid/media/AudioService;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
...
.method static synthetic access$7900(Landroid/media/AudioService;)Landroid/os/PowerManager$WakeLock;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$8600(Landroid/media/AudioService;Landroid/content/ContentResolver;)V
    .locals 0
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$9700(Landroid/media/AudioService;)Landroid/media/AudioService$VolumeController;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method private adjustSuggestedStreamVolume(IIILjava/lang/String;I)V
    ...
    .line 1118
    :cond_2
    iget-object v0, p0, Landroid/media/AudioService;->mWfdSinkVolumePanelLauncher:Lcom/sonymobile/tvout/wifidisplay/volumecontrol/WfdSinkVolumePanelLauncher;

    invoke-virtual {v0, v1, p1}, Lcom/sonymobile/tvout/wifidisplay/volumecontrol/WfdSinkVolumePanelLauncher;->adjustVolume(II)Z
...
.method private checkSoundRegulation()V
    .locals 3
    ...
    const-string/jumbo v2, "sound regulation "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v2, p0, Landroid/media/AudioService;->mSoundRegulation:Z
    ...
    .line 5585
    iget-boolean v0, p0, Landroid/media/AudioService;->mSoundRegulation:Z

    if-eqz v0, :cond_0

    .line 5586
    const-string/jumbo v0, "sound_regulation=on"
    ...
    .line 5588
    :cond_0
    const-string/jumbo v0, "sound_regulation=off"
...
.method private sendDeviceConnectionIntent(IILjava/lang/String;)V
    ...
    :try_start_1
    invoke-static {v11, v2, v3}, Landroid/app/ActivityManagerNative;->broadcastStickyIntent(Landroid/content/Intent;Ljava/lang/String;I)V
    ...
    .line 4902
    .local v10, "extraIntent":Landroid/content/Intent;
    const-string v2, "com.sonyericsson.system.intent.action.HEADSET_PLUG"
    ...
    invoke-static {v10, v2, v3}, Landroid/app/ActivityManagerNative;->broadcastStickyIntent(Landroid/content/Intent;Ljava/lang/String;I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    .line 4908
    .end local v10    # "extraIntent":Landroid/content/Intent;
    :cond_2
    ...
    invoke-direct {v0, v11, v1}, Landroid/media/AudioService;->configureHdmiPlugIntent(Landroid/content/Intent;I)V
    ...
    .line 4875
    const-string v2, "com.sonymobile.media.intent.action.ACTION_EXTERNAL_STEREO_MIC_PLUG"
...
.method private setRingerModeInt(IZ)V
    ...
    invoke-direct {v0, v1}, Landroid/media/AudioService;->isStreamRoutedToWiredHeadset(I)Z
    ...
    invoke-interface {v13, v2}, Ljava/util/Map$Entry;->setValue(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private setStreamVolume(IIILjava/lang/String;I)V
    ...
    .line 1344
    .local v8, "isCheckSafeMediaStatus":Z
...
.method public onSystemReady()V
    ...
    .line 746
    const-string v0, "load_parameter"
