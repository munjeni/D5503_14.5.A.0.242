...
.method private needToSetSettingsForAlarm(Landroid/media/MediaScanner$FileEntry;)Z
    ...
    invoke-static {v0}, Landroid/media/MediaScanner;->access$3000(Landroid/media/MediaScanner;)Ljava/lang/String;
    ...
    # getter for: Landroid/media/MediaScanner;->mDefaultAlarmAlertFilename:Ljava/lang/String;
    invoke-static {v1}, Landroid/media/MediaScanner;->access$3000(Landroid/media/MediaScanner;)Ljava/lang/String;
...
.method private needToSetSettingsForNotification(Landroid/media/MediaScanner$FileEntry;)Z
    ...
    # invokes: Landroid/media/MediaScanner;->isSoundCustomized()Z
    invoke-static {v3}, Landroid/media/MediaScanner;->access$2400(Landroid/media/MediaScanner;)Z
...
.method private parseDateTime(Ljava/lang/String;)J
    .locals 11
    ...
    const-string/jumbo v9, "yyyyMMdd\'T\'HHmmss.SSS\'Z\'"

    aput-object v9, v3, v8

    const/4 v8, 0x1

    const-string/jumbo v9, "yyyy-MM-dd\'T\'HH:mm:ssZ"
    ...
    const-string v10, "Unable to parse dateTime \""
...
.method private toValues()Landroid/content/ContentValues;
    ...
    .line 932
    :cond_1
    iget-wide v2, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mDateTime:J
    ...
    iget-wide v4, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mDateTime:J
    ...
    iget v3, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mBitRate:I
    ...
    # getter for: Landroid/media/MediaScanner;->mInternal:Z
    invoke-static {v2}, Landroid/media/MediaScanner;->access$1200(Landroid/media/MediaScanner;)Z
    ...
    .line 955
    const-string v2, "audiosampledepth"

    iget v3, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mSampleDepth:I
    ...
    iget v3, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mSampleRate:I
...
.method public beginFile(Ljava/lang/String;Ljava/lang/String;JJZZ)Landroid/media/MediaScanner$FileEntry;
    ...
    iput-wide v4, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mDateTime:J

    .line 622
    const/4 v3, -0x1

    iput v3, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mSampleRate:I

    .line 623
    const/4 v3, -0x1

    iput v3, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mBitRate:I

    .line 624
    const/4 v3, -0x1

    iput v3, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mSampleDepth:I
...
.method public doScanFile(Ljava/lang/String;Ljava/lang/String;JJZZZ)Landroid/net/Uri;
    ...
    iget-boolean v4, v0, Landroid/media/MediaScanner$MyMediaScannerClient;->mUnknownTypeDrm:Z
...
.method public handleStringTag(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1}, Landroid/media/MediaScanner$MyMediaScannerClient;->parseDateTime(Ljava/lang/String;)J

    move-result-wide v2

    iput-wide v2, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mDateTime:J
    ...
    iput v1, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mSampleRate:I
    ...
    iput v1, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mBitRate:I
    ...
    iput v1, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mSampleDepth:I
