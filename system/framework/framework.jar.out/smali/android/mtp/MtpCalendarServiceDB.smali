...
.method private addAlarmInfo(IILandroid/database/Cursor;Landroid/mtp/MtpPropertyList;)V
    ...
    iget-object v0, p0, Landroid/mtp/MtpCalendarServiceDB;->mContentResolver:Landroid/content/ContentResolver;
...
.method private getEventRule(ILandroid/database/Cursor;ILandroid/mtp/MtpPropertyList;)Landroid/mtp/MtpDeviceServiceTool$EventRule;
    ...
    iput-wide v4, v1, Landroid/mtp/MtpDeviceServiceTool$EventRule;->originalInstanceTime:J
...
.method private insertLocalCalendar()J
    ...
    .line 84
    iget-object v2, p0, Landroid/mtp/MtpCalendarServiceDB;->mContentResolver:Landroid/content/ContentResolver;
...
.method private updateException(ILandroid/content/ContentValues;Ljava/lang/String;)V
    ...
    iget-object v11, v0, Landroid/mtp/MtpCalendarServiceDB;->mContentResolver:Landroid/content/ContentResolver;

    sget-object v12, Landroid/provider/CalendarContract$Events;->CONTENT_URI:Landroid/net/Uri;

    const-string/jumbo v13, "original_id = ? AND eventStatus = ?"
    ...
    .line 377
    .local v5, "exception":Landroid/content/ContentValues;
    move-object v2, v4
    ...
    invoke-static {v3, v10}, Landroid/mtp/MtpDeviceServiceTool;->parseDateTime2445(Ljava/lang/String;Ljava/lang/String;)J
    ...
    .line 381
    const-string/jumbo v11, "original_sync_id"
    ...
    sget-object v12, Landroid/provider/CalendarContract$Events;->CONTENT_EXCEPTION_URI:Landroid/net/Uri;
...
.method protected getChangedItems()[Landroid/mtp/MtpServiceDatabase$ChangeItem;
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/mtp/MtpCalendarServiceDB;->getChangedItems(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)[Landroid/mtp/MtpServiceDatabase$ChangeItem;
...
.method public getNumObjects()I
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/mtp/MtpCalendarServiceDB;->getNumObjects(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
...
.method public getObjectHandles()[I
    ...
    invoke-virtual {p0, v0, v1, v2, v3}, Landroid/mtp/MtpCalendarServiceDB;->getObjectHandles(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;I)[I
...
.method public getObjectPropertyList(IIIII)Landroid/mtp/MtpPropertyList;
    ...
    invoke-virtual {v0, v1}, Landroid/mtp/MtpCalendarServiceDB;->getObjectsPUID(I)Landroid/mtp/MtpPropertyList;
    ...
    .line 462
    .local v2, "mtpPropertyList":Landroid/mtp/MtpPropertyList;
    const v4, 0xdd81
    ...
    iget-object v3, v0, Landroid/mtp/MtpCalendarServiceDB;->mContentResolver:Landroid/content/ContentResolver;
    ...
    invoke-direct {v0, v1, v11, v9, v2}, Landroid/mtp/MtpCalendarServiceDB;->addBaseInfo(IILandroid/database/Cursor;Landroid/mtp/MtpPropertyList;)Landroid/mtp/MtpDeviceServiceTool$EventRule;

    move-result-object v12

    .line 473
    .local v12, "eventRule":Landroid/mtp/MtpDeviceServiceTool$EventRule;
    move-object/from16 v0, p0

    move/from16 v1, p1

    invoke-direct {v0, v1, v11, v9, v2}, Landroid/mtp/MtpCalendarServiceDB;->addAlarmInfo(IILandroid/database/Cursor;Landroid/mtp/MtpPropertyList;)V
    ...
    invoke-direct {v0, v1, v12, v9, v2}, Landroid/mtp/MtpCalendarServiceDB;->addOriginalEventInfo(ILandroid/mtp/MtpDeviceServiceTool$EventRule;Landroid/database/Cursor;Landroid/mtp/MtpPropertyList;)V
    ...
    .line 478
    .local v13, "modifiedTime":Ljava/lang/String;
    if-nez v13, :cond_2
    ...
    invoke-static {v4, v5}, Landroid/mtp/MtpDeviceServiceTool;->getDateTime2445(J)Ljava/lang/String;
    ...
    invoke-direct {v0, v11, v13}, Landroid/mtp/MtpCalendarServiceDB;->updateModifyTime(ILjava/lang/String;)V
    ...
    invoke-virtual {v2, v0, v3, v13}, Landroid/mtp/MtpPropertyList;->append(IILjava/lang/String;)V
    ...
    invoke-direct {v0, v11, v3}, Landroid/mtp/MtpCalendarServiceDB;->updateUUID(ILjava/lang/String;)V
    ...
    .line 495
    invoke-static {v2}, Landroid/mtp/MtpPropertyListHelper;->filterNullProperty(Landroid/mtp/MtpPropertyList;)Landroid/mtp/MtpPropertyList;
    :try_end_0
    ...
    .line 503
    .end local v12    # "eventRule":Landroid/mtp/MtpDeviceServiceTool$EventRule;
    .end local v13    # "modifiedTime":Ljava/lang/String;
    ...
    .end local v2    # "mtpPropertyList":Landroid/mtp/MtpPropertyList;
    const/4 v3, 0x0
    ...
    .restart local v2    # "mtpPropertyList":Landroid/mtp/MtpPropertyList;
    goto :goto_1
...
.method public handleData(ILandroid/mtp/MtpPropertyList;)[I
    ...
    iget-wide v14, v3, Landroid/mtp/MtpDeviceServiceTool$EventRule;->startTime:J
    ...
    iget-wide v14, v0, Landroid/mtp/MtpCalendarServiceDB;->mCalendarId:J
    ...
    invoke-static {v14, v15}, Landroid/mtp/MtpDeviceServiceTool;->getDateTime2445(J)Ljava/lang/String;
    ...
    iget-wide v14, v3, Landroid/mtp/MtpDeviceServiceTool$EventRule;->originalInstanceTime:J
    ...
    iget-object v12, v0, Landroid/mtp/MtpCalendarServiceDB;->mContentResolver:Landroid/content/ContentResolver;
    ...
    iget-wide v14, v3, Landroid/mtp/MtpDeviceServiceTool$EventRule;->endTime:J
...
.method protected processUpdatedData([Landroid/mtp/MtpServiceDatabase$ChangeItem;)V
    ...
    invoke-virtual {p0, v1, v0, v2}, Landroid/mtp/MtpCalendarServiceDB;->cleanDeletedItems(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/mtp/MtpCalendarServiceDB;->updateDirtyData(Landroid/net/Uri;[Landroid/mtp/MtpServiceDatabase$ChangeItem;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
