...
.method public addAnchor(Ljava/lang/String;III)Z
    ...
    .line 247
    invoke-virtual {p0}, Landroid/mtp/MtpDeviceServiceDBHelper;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
...
.method public getAnchorInfo(Ljava/lang/String;Ljava/lang/String;)Landroid/mtp/MtpDeviceServiceDBHelper$AnchorInfo;
    ...
    invoke-virtual {p0}, Landroid/mtp/MtpDeviceServiceDBHelper;->getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;
...
.method public getServicePropertyList(II)Landroid/mtp/MtpPropertyList;
    ...
    invoke-direct {v6, v0, v1}, Landroid/mtp/MtpPropertyList;-><init>(II)V

    .line 336
    .local v6, "mtpPropertyList":Landroid/mtp/MtpPropertyList;
    :goto_1
    ...
    invoke-static/range {v6 .. v12}, Landroid/mtp/MtpPropertyListHelper;->append(Landroid/mtp/MtpPropertyList;IIIJLjava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 346
    .end local v6    # "mtpPropertyList":Landroid/mtp/MtpPropertyList;
    :catchall_0
    move-exception v0
    ...
    .line 346
    .restart local v6    # "mtpPropertyList":Landroid/mtp/MtpPropertyList;
    :cond_1
    invoke-interface {v13}, Landroid/database/Cursor;->close()V
