...
.method public getObjectPropertyList(IIIII)Landroid/mtp/MtpPropertyList;
    ...
    .line 465
    .local v4, "mtpPropertyList":Landroid/mtp/MtpPropertyList;
    const v6, 0xdd80
    ...
    .line 471
    new-instance v10, Landroid/mtp/MtpContactServiceDB$PropertyIndex;

    const/4 v5, 0x0

    invoke-direct {v10, v5}, Landroid/mtp/MtpContactServiceDB$PropertyIndex;-><init>(Landroid/mtp/MtpContactServiceDB$1;)V

    .line 472
    .local v10, "propIndex":Landroid/mtp/MtpContactServiceDB$PropertyIndex;
    :cond_2
    :goto_1
    ...
    invoke-direct {v0, v1, v2, v4}, Landroid/mtp/MtpContactServiceDB;->addBaseInfo(ILandroid/database/Cursor;Landroid/mtp/MtpPropertyList;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 524
    .end local v4    # "mtpPropertyList":Landroid/mtp/MtpPropertyList;
    .end local v7    # "subType":I
    .end local v9    # "value":Ljava/lang/String;
    .end local v10    # "propIndex":Landroid/mtp/MtpContactServiceDB$PropertyIndex;
    ...
    .line 479
    .restart local v4    # "mtpPropertyList":Landroid/mtp/MtpPropertyList;
    .restart local v7    # "subType":I
    .restart local v9    # "value":Ljava/lang/String;
    .restart local v10    # "propIndex":Landroid/mtp/MtpContactServiceDB$PropertyIndex;
    ...
    .line 480
    invoke-direct/range {v5 .. v10}, Landroid/mtp/MtpContactServiceDB;->addPhoneInfo(IILandroid/mtp/MtpPropertyList;Ljava/lang/String;Landroid/mtp/MtpContactServiceDB$PropertyIndex;)V
    ...
    .line 482
    invoke-direct/range {v5 .. v10}, Landroid/mtp/MtpContactServiceDB;->addEmailInfo(IILandroid/mtp/MtpPropertyList;Ljava/lang/String;Landroid/mtp/MtpContactServiceDB$PropertyIndex;)V
    ...
    invoke-direct {v0, v1, v4, v9, v10}, Landroid/mtp/MtpContactServiceDB;->addIMInfo(ILandroid/mtp/MtpPropertyList;Ljava/lang/String;Landroid/mtp/MtpContactServiceDB$PropertyIndex;)V
    ...
    invoke-direct {v0, v1, v7, v2, v4}, Landroid/mtp/MtpContactServiceDB;->addOrganizationInfo(IILandroid/database/Cursor;Landroid/mtp/MtpPropertyList;)V
    ...
    invoke-direct {v0, v1, v7, v2, v4}, Landroid/mtp/MtpContactServiceDB;->addStructuredPostalInfo(IILandroid/database/Cursor;Landroid/mtp/MtpPropertyList;)V
    ...
    invoke-direct {v0, v1, v7, v4, v9}, Landroid/mtp/MtpContactServiceDB;->addEventInfo(IILandroid/mtp/MtpPropertyList;Ljava/lang/String;)V
    ...
    .line 492
    iget v5, v10, Landroid/mtp/MtpContactServiceDB$PropertyIndex;->webSiteIndex:I
    ...
    invoke-virtual {v4, v0, v5, v9}, Landroid/mtp/MtpPropertyList;->append(IILjava/lang/String;)V
    ...
    iput v5, v10, Landroid/mtp/MtpContactServiceDB$PropertyIndex;->webSiteIndex:I
    ...
    invoke-virtual {v4, v0, v5, v6, v9}, Landroid/mtp/MtpPropertyList;->append(IIILjava/lang/String;)V
    ...
    invoke-direct {v0, v1, v7, v4, v9}, Landroid/mtp/MtpContactServiceDB;->addRelationInfo(IILandroid/mtp/MtpPropertyList;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v0, v5, v6, v8}, Landroid/mtp/MtpPropertyList;->append(IIILjava/lang/String;)V
    ...
    const-wide/32 v16, 0xff04

    move-object v12, v4

    move/from16 v13, p1

    invoke-virtual/range {v12 .. v17}, Landroid/mtp/MtpPropertyList;->append(IIIJ)V
    ...
    .line 518
    invoke-static {v4}, Landroid/mtp/MtpPropertyListHelper;->filterNullProperty(Landroid/mtp/MtpPropertyList;)Landroid/mtp/MtpPropertyList;
    :try_end_1
...
.method public handleData(ILandroid/mtp/MtpPropertyList;)[I
    ...
    invoke-static {v6, v7}, Landroid/mtp/MtpDeviceServiceTool;->getDateTime2445(J)Ljava/lang/String;
