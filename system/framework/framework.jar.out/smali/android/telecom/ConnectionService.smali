...
.field private static final MSG_ADD_SOMC_CONNECTION_SERVICE_ADAPTER:I = 0x64
...
.field private final mSomcAdapter:Landroid/telecom/SomcConnectionServiceAdapterExtend;
...
.method public constructor <init>()V
    ...
    .line 101
    new-instance v0, Landroid/telecom/SomcConnectionServiceAdapterExtend;

    invoke-direct {v0}, Landroid/telecom/SomcConnectionServiceAdapterExtend;-><init>()V

    iput-object v0, p0, Landroid/telecom/ConnectionService;->mSomcAdapter:Landroid/telecom/SomcConnectionServiceAdapterExtend;
...
.method static synthetic access$2500(Landroid/telecom/ConnectionService;)Landroid/telecom/SomcConnectionServiceAdapterExtend;
    .locals 1
    .param p0, "x0"    # Landroid/telecom/ConnectionService;

    .prologue
    .line 55
    iget-object v0, p0, Landroid/telecom/ConnectionService;->mSomcAdapter:Landroid/telecom/SomcConnectionServiceAdapterExtend;
...
.method static synthetic access$2800(Landroid/telecom/ConnectionService;Landroid/telecom/Conference;)V
    .locals 0
    .param p0, "x0"    # Landroid/telecom/ConnectionService;
...
.method static synthetic access$3100(Landroid/telecom/ConnectionService;)I
    .locals 1
    .param p0, "x0"    # Landroid/telecom/ConnectionService;
...
.method static synthetic access$3102(Landroid/telecom/ConnectionService;I)I
    .locals 0
    .param p0, "x0"    # Landroid/telecom/ConnectionService;
    .param p1, "x1"    # I
...
.method static synthetic access$3200(Landroid/telecom/ConnectionService;Ljava/util/List;)Ljava/util/List;
    .locals 1
    .param p0, "x0"    # Landroid/telecom/ConnectionService;
    .param p1, "x1"    # Ljava/util/List;
...
.method static synthetic access$3300(Landroid/telecom/ConnectionService;)Landroid/telecom/RemoteConnectionManager;
    .locals 1
    .param p0, "x0"    # Landroid/telecom/ConnectionService;
...
.method static synthetic access$3400(Landroid/telecom/ConnectionService;)V
    .locals 0
    .param p0, "x0"    # Landroid/telecom/ConnectionService;
...
.method private createConnection(Landroid/telecom/PhoneAccountHandle;Ljava/lang/String;Landroid/telecom/ConnectionRequest;ZZ)V
    ...
    invoke-virtual {v0, v1}, Landroid/telecom/ConnectionService;->initSetUpExtraParams(Landroid/telecom/Connection;)V
    ...
    invoke-virtual/range {v20 .. v20}, Landroid/telecom/Connection;->getExtraParams()[Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3, v4}, Landroid/telecom/ParcelableConnection;->setExtraParams([Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v0, v1, v3}, Landroid/telecom/ConnectionServiceAdapter;->handleCreateConnectionComplete(Ljava/lang/String;Landroid/telecom/ConnectionRequest;Landroid/telecom/ParcelableConnection;)V
...
.method public initSetUpExtraParams(Landroid/telecom/Connection;)V
    .locals 0
    .param p1, "connection"    # Landroid/telecom/Connection;
