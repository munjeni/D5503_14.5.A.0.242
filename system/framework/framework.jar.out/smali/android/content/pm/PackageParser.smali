...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/content/pm/PackageParser$ResourcePreloader;,
...
.field private static final META_DATA_RUNTIMESKINNING_RETAIN:Ljava/lang/String; = "com.sonymobile.runtimeskinning.RETAIN_ACTIVITY"
...
.field public static final PARSE_PREFETCH_RESOURCES:I = 0x400
...
.field private static sPreloader:Landroid/content/pm/PackageParser$ResourcePreloader;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/content/pm/PackageParser;->sPreloader:Landroid/content/pm/PackageParser$ResourcePreloader;
...
.method static synthetic access$200(Ljava/lang/String;Ljava/lang/CharSequence;[Ljava/lang/String;)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$300(Ljava/lang/String;Ljava/lang/String;Ljava/lang/CharSequence;I[Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Ljava/lang/String;
...
.method public static createPreloader()V
    .locals 2

    .prologue
    .line 775
    new-instance v0, Landroid/content/pm/PackageParser$ResourcePreloader;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Landroid/content/pm/PackageParser$ResourcePreloader;-><init>(Landroid/content/pm/PackageParser$1;)V

    sput-object v0, Landroid/content/pm/PackageParser;->sPreloader:Landroid/content/pm/PackageParser$ResourcePreloader;

    .line 776
    sget-object v0, Landroid/content/pm/PackageParser;->sPreloader:Landroid/content/pm/PackageParser$ResourcePreloader;

    invoke-virtual {v0}, Landroid/content/pm/PackageParser$ResourcePreloader;->startThread()V

    .line 777
    return-void
.end method

.method public static disposePreloader()V
    .locals 1
    ...
    invoke-virtual {v0}, Landroid/content/pm/PackageParser$ResourcePreloader;->dispose()V
...
.method private parseActivity(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;I[Ljava/lang/String;ZZ)Landroid/content/pm/PackageParser$Activity;
    ...
    const-string v3, "com.sonymobile.runtimeskinning.RETAIN_ACTIVITY"
...
.method public static parseApkLite(Ljava/io/File;I)Landroid/content/pm/PackageParser$ApkLite;
    ...
    .line 1299
    .local v27, "preloaded":Landroid/content/pm/PackageParser$PreloadedResource;
    move/from16 v0, p1
    ...
    .line 1300
    sget-object v4, Landroid/content/pm/PackageParser;->sPreloader:Landroid/content/pm/PackageParser$ResourcePreloader;
    ...
    invoke-virtual {v4, v0, v1, v2}, Landroid/content/pm/PackageParser$ResourcePreloader;->load(Ljava/io/File;Landroid/util/DisplayMetrics;I)Landroid/content/pm/PackageParser$PreloadedResource;
    ...
    iget-object v3, v0, Landroid/content/pm/PackageParser$PreloadedResource;->mAssmgr:Landroid/content/res/AssetManager;

    .line 1310
    move-object/from16 v0, v27

    iget v0, v0, Landroid/content/pm/PackageParser$PreloadedResource;->mCookie:I
    ...
    iget-object v5, v0, Landroid/content/pm/PackageParser$PreloadedResource;->mRes:Landroid/content/res/Resources;

    .line 1318
    move-object/from16 v0, v27

    iget-object v6, v0, Landroid/content/pm/PackageParser$PreloadedResource;->mParser:Landroid/content/res/XmlResourceParser;
    :try_end_0
    ...
    invoke-direct {v4, v8, v10}, Landroid/content/pm/PackageParser$PackageParserException;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {v4, v8, v10, v0}, Landroid/content/pm/PackageParser$PackageParserException;-><init>(ILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_1
    :try_start_3
    new-instance v22, Landroid/content/res/AssetManager;

    invoke-direct/range {v22 .. v22}, Landroid/content/res/AssetManager;-><init>()V
    :try_end_3
    ...
    .local v22, "assets":Landroid/content/res/AssetManager;
    :try_start_4
    ...
    .end local v22    # "assets":Landroid/content/res/AssetManager;
    .restart local v3    # "assets":Landroid/content/res/AssetManager;
    goto :goto_0
    ...
    invoke-direct {v0, v3, v1, v4}, Landroid/content/res/Resources;-><init>(Landroid/content/res/AssetManager;Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;)V
    :try_end_5
    ...
    invoke-virtual {v3, v0, v4}, Landroid/content/res/AssetManager;->openXmlResourceParser(ILjava/lang/String;)Landroid/content/res/XmlResourceParser;
    :try_end_6
    ...
    .line 1335
    :try_start_7
    new-instance v29, Landroid/content/pm/PackageParser$Package;

    const/4 v4, 0x0

    move-object/from16 v0, v29

    invoke-direct {v0, v4}, Landroid/content/pm/PackageParser$Package;-><init>(Ljava/lang/String;)V

    .line 1336
    .local v29, "tempPkg":Landroid/content/pm/PackageParser$Package;
    const/4 v4, 0x0
    ...
    invoke-static {v0, v1, v4}, Landroid/content/pm/PackageParser;->collectCertificates(Landroid/content/pm/PackageParser$Package;Ljava/io/File;I)V

    .line 1337
    move-object/from16 v0, v29

    iget-object v9, v0, Landroid/content/pm/PackageParser$Package;->mSignatures:[Landroid/content/pm/Signature;

    .line 1342
    .end local v29    # "tempPkg":Landroid/content/pm/PackageParser$Package;
    ...
    .line 1343
    invoke-static/range {v4 .. v9}, Landroid/content/pm/PackageParser;->parseApkLite(Ljava/lang/String;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;I[Landroid/content/pm/Signature;)Landroid/content/pm/PackageParser$ApkLite;
    :try_end_7
    ...
    .end local v3    # "assets":Landroid/content/res/AssetManager;
    .end local v6    # "parser":Landroid/content/res/XmlResourceParser;
    .restart local v22    # "assets":Landroid/content/res/AssetManager;
    .restart local v26    # "parser":Landroid/content/res/XmlResourceParser;
    :catchall_2
    move-exception v4
...
.method private parseBaseApplication(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;I[Ljava/lang/String;)Z
    ...
    .line 2577
    .local v32, "sa":Landroid/content/res/TypedArray;
    const/4 v5, 0x3
    ...
    .line 2591
    .local v23, "manageSpaceActivity":Ljava/lang/String;
    if-eqz v23, :cond_1
    ...
    .line 2633
    .local v36, "v":Landroid/util/TypedValue;
    if-eqz v36, :cond_5
    ...
    .line 2882
    .local v22, "lname":Ljava/lang/String;
    invoke-virtual/range {v32 .. v32}, Landroid/content/res/TypedArray;->recycle()V
    ...
    invoke-static {v5, v0}, Lcom/android/internal/util/ArrayUtils;->contains(Ljava/util/ArrayList;Ljava/lang/Object;)Z
    ...
    .line 2893
    .end local v22    # "lname":Ljava/lang/String;
    :cond_28
    ...
    .line 2901
    .restart local v22    # "lname":Ljava/lang/String;
    const/4 v5, 0x1
...
.method public static requestPreload(Ljava/io/File;Landroid/util/DisplayMetrics;I)V
    .locals 1
    ...
    invoke-virtual {v0, p0, p1, p2}, Landroid/content/pm/PackageParser$ResourcePreloader;->requestPreload(Ljava/io/File;Landroid/util/DisplayMetrics;I)V
