...
.method public static final setLocationProviderEnabledForUser(Landroid/content/ContentResolver;Ljava/lang/String;ZI)Z
    ...
    invoke-virtual {v2}, Landroid/app/admin/DevicePolicyManager;->isLocationDisabledForCurrentUser()Z
    ...
    invoke-static {v8}, Landroid/provider/Settings$Secure;->isUidSystem(I)Z
    ...
    const-string v9, "Unable to show location policy notification: Could not get the package manager."
    ...
    :cond_2
    :try_start_2
    invoke-static {v1}, Landroid/app/admin/PolicyNotification;->showLocationPolicyNotification(Landroid/content/Context;)V
    ...
    const-string v10, "Unable to show location policy notification due to "
    ...
    const-string v9, "Unable to show location policy notification."
    ...
    invoke-static {p0, v6, p1, p3}, Landroid/provider/Settings$Secure;->putStringForUser(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;I)Z
