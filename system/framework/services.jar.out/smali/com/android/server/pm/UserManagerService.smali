...
.method private createUserInternal(Ljava/lang/String;II)Landroid/content/pm/UserInfo;
    ...
    invoke-virtual {v0, v5}, Lcom/android/server/pm/UserManagerService;->getUserRestrictions(I)Landroid/os/Bundle;
    ...
    const-string v6, "Cannot add user. DISALLOW_ADD_USER is enabled."
    ...
    iget-object v6, v0, Lcom/android/server/pm/UserManagerService;->mInstallLock:Ljava/lang/Object;
    ...
    invoke-direct {v0, v5, v8}, Lcom/android/server/pm/UserManagerService;->numberOfUsersOfTypeLocked(IZ)I
    ...
    invoke-direct {v0, v1, v2, v5, v3}, Landroid/content/pm/UserInfo;-><init>(ILjava/lang/String;Ljava/lang/String;I)V
    :try_end_a
    ...
    iget-object v5, v0, Lcom/android/server/pm/UserManagerService;->mBaseUserPath:Ljava/io/File;
    ...
    .line 1175
    .local v22, "userPath":Ljava/io/File;
    move-object/from16 v0, p0

    iget v5, v0, Lcom/android/server/pm/UserManagerService;->mNextSerialNumber:I

    add-int/lit8 v8, v5, 0x1

    move-object/from16 v0, p0

    iput v8, v0, Lcom/android/server/pm/UserManagerService;->mNextSerialNumber:I
    ...
    iput-boolean v5, v0, Landroid/content/pm/UserInfo;->partial:Z
    ...
    iget-object v5, v0, Lcom/android/server/pm/UserManagerService;->mUsers:Landroid/util/SparseArray;
    ...
    .line 1183
    iget v5, v15, Landroid/content/pm/UserInfo;->profileGroupId:I
    ...
    iput v5, v15, Landroid/content/pm/UserInfo;->profileGroupId:I

    .line 1185
    move-object/from16 v0, p0

    invoke-direct {v0, v15}, Lcom/android/server/pm/UserManagerService;->writeUserLocked(Landroid/content/pm/UserInfo;)V
    ...
    invoke-direct {v0, v1}, Lcom/android/server/pm/UserManagerService;->writeUserLocked(Landroid/content/pm/UserInfo;)V

    .line 1190
    move-object/from16 v0, p0

    iget-object v5, v0, Lcom/android/server/pm/UserManagerService;->mPm:Lcom/android/server/pm/PackageManagerService;

    move/from16 v0, v19

    move-object/from16 v1, v22

    invoke-virtual {v5, v0, v1}, Lcom/android/server/pm/PackageManagerService;->createNewUserLILPw(ILjava/io/File;)V
    ...
    iget-object v5, v0, Lcom/android/server/pm/UserManagerService;->mUserRestrictions:Landroid/util/SparseArray;
    ...
    const-string v6, "UA-51142570-15"

    const-string v7, "feature-usage"

    const-string v8, "Multi-user created new user"

    const-string v9, "PID009803"
    ...
    :goto_3
    invoke-static/range {v5 .. v11}, Lcom/sonymobile/ga/GAManager;->pushEvent(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V
    ...
    .line 1204
    .local v4, "addedIntent":Landroid/content/Intent;
    ...
    .line 1209
    .end local v4    # "addedIntent":Landroid/content/Intent;
    :cond_8
    invoke-static {v12, v13}, Landroid/os/Binder;->restoreCallingIdentity(J)V
    ...
    .end local v22    # "userPath":Ljava/io/File;
    .restart local v20    # "userInfo":Landroid/content/pm/UserInfo;
    :catchall_0
    move-exception v5
    ...
    .end local v20    # "userInfo":Landroid/content/pm/UserInfo;
    .restart local v15    # "parent":Landroid/content/pm/UserInfo;
    .restart local v18    # "restrictions":Landroid/os/Bundle;
    .restart local v19    # "userId":I
    .restart local v21    # "userInfo":Landroid/content/pm/UserInfo;
    .restart local v22    # "userPath":Ljava/io/File;
    :cond_a
