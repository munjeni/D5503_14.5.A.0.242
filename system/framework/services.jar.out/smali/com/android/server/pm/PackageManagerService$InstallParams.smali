...
.method private isVerificationRequired()Z
    .locals 10
    ...
    .line 9392
    .local v6, "trustedInstallerList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    iget-object v8, p0, Lcom/android/server/pm/PackageManagerService$InstallParams;->this$0:Lcom/android/server/pm/PackageManagerService;

    iget-object v9, p0, Lcom/android/server/pm/PackageManagerService$InstallParams;->verificationParams:Landroid/content/pm/VerificationParams;

    invoke-virtual {v9}, Landroid/content/pm/VerificationParams;->getInstallerUid()I

    move-result v9

    invoke-virtual {v8, v9}, Lcom/android/server/pm/PackageManagerService;->getPackagesForUid(I)[Ljava/lang/String;

    move-result-object v1

    .line 9395
    .local v1, "callerPackageNames":[Ljava/lang/String;
    if-eqz v1, :cond_1
    ...
    invoke-virtual {v8, v4, v7, v9}, Lcom/android/server/pm/PackageManagerService;->getPackageInfo(Ljava/lang/String;II)Landroid/content/pm/PackageInfo;
...
.method public handleStartCopy()V
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/pm/PackageManagerService$InstallParams;->isVerificationRequired()Z
