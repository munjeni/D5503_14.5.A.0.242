...
.method static synthetic access$1000(Lcom/android/server/MountService;)Lcom/android/server/NativeDaemonConnector;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$1100(Lcom/android/server/MountService;)Ljava/lang/Object;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$1200(Lcom/android/server/MountService;Landroid/os/UserHandle;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$1400(Lcom/android/server/MountService;Landroid/os/storage/StorageVolume;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$900(Lcom/android/server/MountService;)V
    ...
    .prologue
    .line 131
    invoke-direct {p0}, Lcom/android/server/MountService;->doUpdateLastMaintenance()V
...
.method private doMountVolume(Ljava/lang/String;)I
    ...
    invoke-direct/range {p0 .. p1}, Lcom/android/server/MountService;->isExternalUsbStorage(Ljava/lang/String;)Z
    ...
    invoke-static {v13, v11, v8, v7}, Landroid/app/admin/PolicyNotification;->showPolicyNotification(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)V

    .line 1168
    const/4 v13, -0x5

    .line 1228
    .end local v4    # "doMount":Z
    ...
    .line 1139
    .restart local v4    # "doMount":Z
    .restart local v5    # "dpm":Landroid/app/admin/DevicePolicyManager;
    .restart local v12    # "volume":Landroid/os/storage/StorageVolume;
    :cond_2
    const/4 v13, 0x0

    invoke-virtual {v5, v13}, Landroid/app/admin/DevicePolicyManager;->isMountingExternalStorageDisabled(Landroid/content/ComponentName;)Z
    ...
    invoke-virtual {v5, v13}, Landroid/app/admin/DevicePolicyManager;->getSdcardEncryption(Landroid/content/ComponentName;)Z

    move-result v13

    if-eqz v13, :cond_1

    invoke-virtual/range {p0 .. p0}, Lcom/android/server/MountService;->isExternalSdCardUnencrypted()Z
    ...
    .line 1182
    const-string v13, "persist.sys.usb.config"
...
.method private doUpdateLastMaintenance()V
    .locals 4
    ...
    iput-wide v2, p0, Lcom/android/server/MountService;->mLastMaintenance:J

    .line 726
    iget-object v1, p0, Lcom/android/server/MountService;->mLastMaintenanceFile:Ljava/io/File;

    iget-wide v2, p0, Lcom/android/server/MountService;->mLastMaintenance:J
...
.method private getPrimaryPhysicalVolume()Landroid/os/storage/StorageVolume;
    ...
    invoke-direct {p0, v1}, Lcom/android/server/MountService;->isExternalAppsEnabledForVolume(Landroid/os/storage/StorageVolume;)Z
...
.method private handleSystemReady()V
    ...
    invoke-direct {p0, v9, v2, v10, v11}, Lcom/android/server/MountService;->notifyVolumeStateChange(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    .line 613
    .local v8, "volumePaths":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    iget-object v10, p0, Lcom/android/server/MountService;->mVolumesLock:Ljava/lang/Object;
    ...
    invoke-direct {p0, v9, v7, v10, v11}, Lcom/android/server/MountService;->notifyVolumeStateChange(Ljava/lang/String;Ljava/lang/String;II)V
...
.method private isExternalAppsEnabledForVolume(Landroid/os/storage/StorageVolume;)Z
    .locals 3
    .param p1, "volume"    # Landroid/os/storage/StorageVolume;
    ...
    invoke-virtual {v0, p1}, Landroid/os/storage/StorageManager;->getVolumeType(Landroid/os/storage/StorageVolume;)Landroid/os/storage/StorageManager$StorageType;
...
.method private isExternalUsbStorage(Ljava/lang/String;)Z
    .locals 2
    .param p1, "path"    # Ljava/lang/String;

    .prologue
    .line 1244
    const-string v1, "EXTERNAL_STORAGE_USB"
    ...
    .line 1245
    .local v0, "usbStorage":Ljava/lang/String;
    if-eqz v0, :cond_0
...
.method private updatePublicVolumeState(Landroid/os/storage/StorageVolume;Ljava/lang/String;)V
    ...
    .line 750
    .local v10, "oldState":Ljava/lang/String;
    ...
    const-string v14, "Duplicate state transition (%s -> %s) for %s"
    ...
    .line 751
    .end local v10    # "oldState":Ljava/lang/String;
    :catchall_0
    move-exception v13
    ...
    .line 759
    .restart local v10    # "oldState":Ljava/lang/String;
    :cond_0
    const-string v13, "MountService"
    ...
    const-string v15, "volume state changed for "
    ...
    iget-object v13, v0, Lcom/android/server/MountService;->mPms:Lcom/android/server/pm/PackageManagerService;
    ...
    invoke-virtual {v14, v15, v11}, Lcom/android/server/MountService$ObbActionHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    iget-object v14, v0, Lcom/android/server/MountService;->mListeners:Ljava/util/ArrayList;
    ...
    iget-object v13, v0, Lcom/android/server/MountService;->mListeners:Ljava/util/ArrayList;
    ...
    :try_start_3
    iget-object v13, v2, Lcom/android/server/MountService$MountServiceBinderListener;->mListener:Landroid/os/storage/IMountServiceListener;

    move-object/from16 v0, p2

    invoke-interface {v13, v11, v10, v0}, Landroid/os/storage/IMountServiceListener;->onStorageStateChanged(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_3
    ...
    :goto_4
    invoke-virtual/range {p1 .. p1}, Landroid/os/storage/StorageVolume;->getMaxFileSize()J
    ...
    invoke-virtual {v0, v8, v9}, Landroid/os/storage/StorageVolume;->setMaxFileSize(J)V
    ...
    const-string v15, "Listener dead"
    ...
    .end local v2    # "bl":Lcom/android/server/MountService$MountServiceBinderListener;
    .end local v5    # "i":I
    .end local v12    # "rex":Landroid/os/RemoteException;
    :catchall_1
    move-exception v13
    ...
    const-string v15, "Listener failed"

    invoke-static {v13, v15, v4}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method public decryptStorage(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/server/MountService;->decryptStorage(Ljava/lang/String;Z)I
...
.method public decryptStorage(Ljava/lang/String;Z)I
    .locals 9
    .param p1, "password"    # Ljava/lang/String;
    .param p2, "useCache"    # Z
...
.method public encryptStorage(ILjava/lang/String;)I
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/android/server/MountService;->encryptStorage(ILjava/lang/String;Z)I
...
.method public encryptStorage(ILjava/lang/String;Z)I
    .locals 8
    .param p1, "type"    # I
    .param p2, "password"    # Ljava/lang/String;
    .param p3, "encryptExternal"    # Z
    ...
    const-string v6, "internal-external"
...
.method public isExternalSdCardUnencrypted()Z
    ...
    const-string v8, "testifunencrypted"
...
.method public setUsbMassStorageEnabled(Z)V
    ...
    invoke-direct {p0, v6}, Lcom/android/server/MountService;->validateUserRestriction(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v6}, Landroid/app/admin/DevicePolicyManager;->isUsbMassStorageDisabled(Landroid/content/ComponentName;)Z
    ...
    invoke-direct {v4, p0, v2, v1, v8}, Lcom/android/server/MountService$UmsEnableCallBack;-><init>(Lcom/android/server/MountService;Ljava/lang/String;Ljava/lang/String;Z)V
...
.method public updateLastMaintenance()V
    .locals 1
