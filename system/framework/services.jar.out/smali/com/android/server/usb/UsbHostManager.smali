...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 73
    iput-boolean v1, p0, Lcom/android/server/usb/UsbHostManager;->isBlacklisted:Z
...
.method private beginUsbDeviceAdded(Ljava/lang/String;IIIIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iput-boolean v3, p0, Lcom/android/server/usb/UsbHostManager;->isBlacklisted:Z
...
.method private endUsbDeviceAdded()V
    ...
    .line 302
    iget-boolean v0, p0, Lcom/android/server/usb/UsbHostManager;->isBlacklisted:Z
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/usb/UsbSettingsManager;->blacklistedDeviceAttached(Landroid/hardware/usb/UsbDevice;)V

    .line 307
    :goto_1
    iget-boolean v0, p0, Lcom/android/server/usb/UsbHostManager;->mPS3BtSupport:Z

    if-eqz v0, :cond_4

    iget-object v0, p0, Lcom/android/server/usb/UsbHostManager;->mPS3BtIntentSender:Lcom/sony/wirelesscontroller/WirelessControllerIntentSender;
    ...
    invoke-static {v0, v2}, Lcom/sony/wirelesscontroller/WirelessControllerIntentSender;->isWirelessControllerId(II)Z
    ...
    invoke-virtual {v0, v2}, Lcom/sony/wirelesscontroller/WirelessControllerIntentSender;->sendUsbConnectedIntent(Landroid/hardware/usb/UsbDevice;)V
...
.method private usbDeviceRemoved(Ljava/lang/String;)V
    ...
    invoke-virtual {v7}, Landroid/hardware/usb/UsbDevice;->getDeviceSubclass()I

    move-result v2

    invoke-virtual {v7}, Landroid/hardware/usb/UsbDevice;->getDeviceProtocol()I

    move-result v3

    invoke-direct {p0, v0, v2, v3}, Lcom/android/server/usb/UsbHostManager;->isBlackListed(III)Z
    ...
    invoke-virtual {v0, v7}, Lcom/android/server/usb/UsbSettingsManager;->blacklistedDeviceDetached(Landroid/hardware/usb/UsbDevice;)V
    ...
    invoke-virtual {v0}, Lcom/sony/wirelesscontroller/WirelessControllerIntentSender;->sendUsbDisconnectedIntent()V
