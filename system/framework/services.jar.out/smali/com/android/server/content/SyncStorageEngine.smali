...
.method public getMasterSyncAutomatically(I)Z
    ...
    .line 1049
    :try_start_0
    iget-object v8, p0, Lcom/android/server/content/SyncStorageEngine;->mMasterSyncAutomatically:Landroid/util/SparseArray;
    ...
    .line 1051
    .local v2, "autoSyncIsOn":Z
    :goto_0
    const/4 v1, 0x1

    .line 1053
    .local v1, "autoSyncAllowed":Z
    if-eqz v2, :cond_5

    .line 1054
    iget-object v8, p0, Lcom/android/server/content/SyncStorageEngine;->mContext:Landroid/content/Context;
    ...
    const-string v10, "getMasterSyncAutomatically: auto-sync is on"
    ...
    invoke-virtual {v3, v8}, Landroid/app/admin/DevicePolicyManager;->isAutoSyncWhenRoamingDisabled(Landroid/content/ComponentName;)Z
    ...
    .line 1063
    .local v6, "telMan":Landroid/telephony/TelephonyManager;
    const-string v8, "SyncManager"
    ...
    const-string v10, "getMasterSyncAutomatically: auto-sync when roaming is disabled by policy"
    ...
    const-string v10, "getMasterSyncAutomatically: in roaming -> auto-sync is blocked"
    ...
    invoke-static {v8, v7, v5, v4}, Landroid/app/admin/PolicyNotification;->showPolicyNotification(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)V

    .line 1085
    .end local v4    # "iconId":I
    .end local v5    # "info":Ljava/lang/String;
    .end local v6    # "telMan":Landroid/telephony/TelephonyManager;
    .end local v7    # "title":Ljava/lang/String;
    :cond_3
    const/4 v8, 0x0

    invoke-virtual {v3, v8}, Landroid/app/admin/DevicePolicyManager;->isAutoSyncDataDisabled(Landroid/content/ComponentName;)Z
    ...
    const-string v10, "getMasterSyncAutomatically: auto-sync is disabled by policy"
    ...
    .line 1050
    .end local v1    # "autoSyncAllowed":Z
    :cond_6
    ...
    .line 1100
    .restart local v1    # "autoSyncAllowed":Z
    .restart local v2    # "autoSyncIsOn":Z
    :cond_7
    const/4 v2, 0x0
