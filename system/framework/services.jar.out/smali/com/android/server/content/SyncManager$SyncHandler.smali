...
.field mSyncReceiver:Landroid/content/BroadcastReceiver;

.field public final mSyncTimeTracker:Lcom/android/server/content/SyncManager$SyncTimeTracker;

.field private mSyncTriggeredFinished:Z

.field private mSyncTriggeredLock:Ljava/lang/Object;
...
.method public constructor <init>(Lcom/android/server/content/SyncManager;Landroid/os/Looper;)V
    ...
    iput-object v0, p0, Lcom/android/server/content/SyncManager$SyncHandler;->mSyncTriggeredLock:Ljava/lang/Object;

    .line 1991
    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/server/content/SyncManager$SyncHandler;->mSyncTriggeredFinished:Z
    ...
    iput-object v0, p0, Lcom/android/server/content/SyncManager$SyncHandler;->mSyncReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$3500(Lcom/android/server/content/SyncManager$SyncHandler;)Ljava/lang/Object;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager$SyncHandler;

    .prologue
    .line 1964
    iget-object v0, p0, Lcom/android/server/content/SyncManager$SyncHandler;->mSyncTriggeredLock:Ljava/lang/Object;

    return-object v0
.end method

.method static synthetic access$3602(Lcom/android/server/content/SyncManager$SyncHandler;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/content/SyncManager$SyncHandler;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 1964
    iput-boolean p1, p0, Lcom/android/server/content/SyncManager$SyncHandler;->mSyncTriggeredFinished:Z
...
.method private closeActiveSyncContext(Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/content/SyncManager;->access$4100(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
...
.method private dispatchSyncOperation(Lcom/android/server/content/SyncOperation;)Z
    ...
    .line 2757
    :cond_3
    invoke-direct {p0}, Lcom/android/server/content/SyncManager$SyncHandler;->notifySyncAndWaitForReply()V
...
.method private installHandleTooManyDeletesNotification(Landroid/accounts/Account;Ljava/lang/String;JI)V
    ...
    invoke-static {v2}, Lcom/android/server/content/SyncManager;->access$4000(Lcom/android/server/content/SyncManager;)Landroid/app/NotificationManager;
    ...
    invoke-static {v2, v7}, Lcom/android/server/content/SyncManager;->access$4700(Lcom/android/server/content/SyncManager;Landroid/os/UserHandle;)Landroid/content/Context;
...
.method private manageSyncAlarmLocked(JJ)V
    ...
    invoke-static {}, Lcom/android/server/content/SyncManager;->access$4200()J
    ...
    invoke-static/range {v20 .. v20}, Lcom/android/server/content/SyncManager;->access$4400(Lcom/android/server/content/SyncManager;)V
    ...
    invoke-static/range {v20 .. v20}, Lcom/android/server/content/SyncManager;->access$4600(Lcom/android/server/content/SyncManager;)Landroid/app/AlarmManager;
    ...
    invoke-static/range {v22 .. v22}, Lcom/android/server/content/SyncManager;->access$4500(Lcom/android/server/content/SyncManager;)Landroid/app/PendingIntent;
    ...
    # getter for: Lcom/android/server/content/SyncManager;->mSyncAlarmIntent:Landroid/app/PendingIntent;
    invoke-static/range {v21 .. v21}, Lcom/android/server/content/SyncManager;->access$4500(Lcom/android/server/content/SyncManager;)Landroid/app/PendingIntent;
...
.method private manageSyncNotificationLocked()V
    ...
    invoke-static {v10, v9}, Lcom/android/server/content/SyncManager;->access$4302(Lcom/android/server/content/SyncManager;Z)Z
    ...
    # setter for: Lcom/android/server/content/SyncManager;->mNeedSyncActiveNotification:Z
    invoke-static {v9, v8}, Lcom/android/server/content/SyncManager;->access$4302(Lcom/android/server/content/SyncManager;Z)Z
...
.method private notifySyncAndWaitForReply()V
    .locals 13
    ...
    const-string v0, "com.sonymobile.ordered_broadcast.SYNC_TRIGGERED"
    ...
    .line 2793
    .local v8, "endTime":J
    iget-object v12, p0, Lcom/android/server/content/SyncManager$SyncHandler;->mSyncTriggeredLock:Ljava/lang/Object;
    ...
    const-string v2, "com.sonymobile.permission.SYNC_TRIGGERED"

    iget-object v3, p0, Lcom/android/server/content/SyncManager$SyncHandler;->mSyncReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 2797
    :goto_0
    iget-boolean v0, p0, Lcom/android/server/content/SyncManager$SyncHandler;->mSyncTriggeredFinished:Z
    ...
    .line 2803
    .restart local v10    # "remainingTime":J
    :cond_1
    :try_start_1
    iget-object v0, p0, Lcom/android/server/content/SyncManager$SyncHandler;->mSyncTriggeredLock:Ljava/lang/Object;
...
.method private runSyncFinishedOrCanceledLocked(Landroid/content/SyncResult;Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
    ...
    invoke-static {v3, v6}, Lcom/android/server/content/SyncManager;->access$3800(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncOperation;)V
    ...
    invoke-static {v3, v6, v4, v5}, Lcom/android/server/content/SyncManager;->access$3900(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncOperation;J)V
    ...
    # getter for: Lcom/android/server/content/SyncManager;->mNotificationMgr:Landroid/app/NotificationManager;
    invoke-static {v3}, Lcom/android/server/content/SyncManager;->access$4000(Lcom/android/server/content/SyncManager;)Landroid/app/NotificationManager;
...
.method private sendSyncStateIntent()V
    ...
    invoke-static {v2}, Lcom/android/server/content/SyncManager;->access$4300(Lcom/android/server/content/SyncManager;)Z
