...
# static fields
.field static final EXCLUDED_SYSTEM_ICONS:Ljava/lang/String; = "excluded_system_bar_icons"
...
.field private mExcludedIcons:Ljava/util/HashSet;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashSet",
            "<",
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput-object v1, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mExcludedIcons:Ljava/util/HashSet;
    ...
    invoke-direct {v1, p0, v2}, Lcom/android/server/statusbar/StatusBarManagerService$1;-><init>(Lcom/android/server/statusbar/StatusBarManagerService;Landroid/os/Handler;)V

    iput-object v1, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mContentObserver:Landroid/database/ContentObserver;
    ...
    iget-object v4, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mContentObserver:Landroid/database/ContentObserver;
    ...
    .line 122
    invoke-direct {p0}, Lcom/android/server/statusbar/StatusBarManagerService;->updateSystemIconExclusionList()V

    .line 123
    invoke-direct {p0}, Lcom/android/server/statusbar/StatusBarManagerService;->refreshAllSystemIcons()V
...
.method static synthetic access$100(Lcom/android/server/statusbar/StatusBarManagerService;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/statusbar/StatusBarManagerService;
...
.method static synthetic access$300(Lcom/android/server/statusbar/StatusBarManagerService;)Lcom/android/server/notification/NotificationDelegate;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/statusbar/StatusBarManagerService;
...
.method private disableLocked(IILandroid/os/IBinder;Ljava/lang/String;)V
    ...
    invoke-direct {v2, p0, v0}, Lcom/android/server/statusbar/StatusBarManagerService$3;-><init>(Lcom/android/server/statusbar/StatusBarManagerService;I)V
...
.method private refreshAllSystemIcons()V
    .locals 4
    ...
    invoke-virtual {v2, v0}, Lcom/android/internal/statusbar/StatusBarIconList;->getSlot(I)Ljava/lang/String;

    move-result-object v2

    iget-boolean v3, v1, Lcom/android/internal/statusbar/StatusBarIcon;->visible:Z

    invoke-virtual {p0, v2, v3}, Lcom/android/server/statusbar/StatusBarManagerService;->setIconVisibility(Ljava/lang/String;Z)V
...
.method private updateSystemIconExclusionList()V
    .locals 8
    ...
    iget v7, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mCurrentUserId:I
    ...
    .line 256
    .local v2, "settingsFromDB":Ljava/lang/String;
    iget-object v5, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mExcludedIcons:Ljava/util/HashSet;
    ...
    .line 260
    .local v3, "slots":[Ljava/lang/String;
    ...
    .line 261
    .local v4, "validSlots":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    const-string v5, ";"
    ...
    .end local v3    # "slots":[Ljava/lang/String;
    .end local v4    # "validSlots":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    :cond_1
    return-void
.end method
...
.method public setCurrentUser(I)V
    ...
    iget-object v1, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mContentObserver:Landroid/database/ContentObserver;
    ...
    iget-object v3, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mContentObserver:Landroid/database/ContentObserver;
...
.method public setIcon(Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;)V
    ...
    .line 298
    iget-object v1, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mExcludedIcons:Ljava/util/HashSet;
...
.method public setIconVisibility(Ljava/lang/String;Z)V
    ...
    const-string v6, "invalid status bar icon slot: "
    ...
    .line 330
    .local v2, "shadowIcon":Lcom/android/internal/statusbar/StatusBarIcon;
    iget-object v3, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mExcludedIcons:Ljava/util/HashSet;
    ...
    iput-boolean v3, v2, Lcom/android/internal/statusbar/StatusBarIcon;->visible:Z
    ...
    invoke-interface {v3, v1, v2}, Lcom/android/internal/statusbar/IStatusBar;->setIcon(ILcom/android/internal/statusbar/StatusBarIcon;)V
    :try_end_2
    .catch Landroid/os/RemoteException; {:try_start_2 .. :try_end_2} :catch_0
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
