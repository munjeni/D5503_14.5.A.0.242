...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;Ljava/io/File;Ljava/lang/String;Landroid/app/ApplicationErrorReport$CrashInfo;Landroid/os/DropBoxManager;Lcom/android/server/am/ActivityManagerService$ErrorHandlingInfo;)V
    ...
    iput-object p6, p0, Lcom/android/server/am/ActivityManagerService$20;->val$dropboxTag:Ljava/lang/String;
    ...
    iput-object p9, p0, Lcom/android/server/am/ActivityManagerService$20;->val$errorHandlingInfo:Lcom/android/server/am/ActivityManagerService$ErrorHandlingInfo;
...
.method public run()V
    ...
    const-string v9, "Append trace to dropbox"

    invoke-static {v8, v9}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 12169
    iget-object v8, p0, Lcom/android/server/am/ActivityManagerService$20;->val$dropboxTag:Ljava/lang/String;

    const-string v9, "system_"
    ...
    iget-object v9, p0, Lcom/android/server/am/ActivityManagerService$20;->val$sb:Ljava/lang/StringBuilder;

    invoke-virtual {v9}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;

    move-result-object v9

    # setter for: Lcom/android/server/am/ActivityManagerService;->mDboxText:Ljava/lang/String;
    invoke-static {v8, v9}, Lcom/android/server/am/ActivityManagerService;->access$1602(Lcom/android/server/am/ActivityManagerService;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v10, p0, Lcom/android/server/am/ActivityManagerService$20;->this$0:Lcom/android/server/am/ActivityManagerService;

    # getter for: Lcom/android/server/am/ActivityManagerService;->mDboxText:Ljava/lang/String;
    invoke-static {v10}, Lcom/android/server/am/ActivityManagerService;->access$1600(Lcom/android/server/am/ActivityManagerService;)Ljava/lang/String;
    ...
    .line 12214
    iget-object v8, p0, Lcom/android/server/am/ActivityManagerService$20;->val$errorHandlingInfo:Lcom/android/server/am/ActivityManagerService$ErrorHandlingInfo;

    iget-boolean v8, v8, Lcom/android/server/am/ActivityManagerService$ErrorHandlingInfo;->mSystemDump:Z

    if-eqz v8, :cond_5

    iget-object v8, p0, Lcom/android/server/am/ActivityManagerService$20;->val$errorHandlingInfo:Lcom/android/server/am/ActivityManagerService$ErrorHandlingInfo;

    iget-object v8, v8, Lcom/android/server/am/ActivityManagerService$ErrorHandlingInfo;->mEventType:Ljava/lang/String;
    ...
    iget-object v8, v8, Lcom/android/server/am/ActivityManagerService$ErrorHandlingInfo;->mProcessName:Ljava/lang/String;
    ...
    iget-object v9, p0, Lcom/android/server/am/ActivityManagerService$20;->val$errorHandlingInfo:Lcom/android/server/am/ActivityManagerService$ErrorHandlingInfo;

    invoke-virtual {v8, v9}, Lcom/android/server/am/ActivityManagerService;->forceCrashDump(Lcom/android/server/am/ActivityManagerService$ErrorHandlingInfo;)V
