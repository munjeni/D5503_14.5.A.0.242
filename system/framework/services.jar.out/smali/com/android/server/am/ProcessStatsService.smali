...
.method private getCurrentStatsLocked(Ljava/util/List;)[B
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-wide v8, v7, Lcom/android/internal/app/ProcessStats;->mTimePeriodEndRealtime:J
    ...
    invoke-virtual {v7, v0, v4, v5, v8}, Lcom/android/internal/app/ProcessStats;->writeToParcel(Landroid/os/Parcel;JI)V
...
.method private getStatsOverTimeLocked(J)Landroid/os/ParcelFileDescriptor;
    .locals 25
    .param p1, "minTime"    # J
...
.method public getCurrentStats(Ljava/util/List;)[B
    ...
    .line 450
    :try_start_0
    invoke-direct {p0, p1}, Lcom/android/server/am/ProcessStatsService;->getCurrentStatsLocked(Ljava/util/List;)[B
...
.method public getStatsOverTime(J)Landroid/os/ParcelFileDescriptor;
    ...
    .line 486
    :try_start_0
    invoke-direct {p0, p1, p2}, Lcom/android/server/am/ProcessStatsService;->getStatsOverTimeLocked(J)Landroid/os/ParcelFileDescriptor;
